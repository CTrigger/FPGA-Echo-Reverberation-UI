...
namespace Friendship404
{
    class BluetoothServices
    {
        ...
        private void SetState(int state)
        {
            ...
            _handler.ObtainMessage(EqualizerController.MESSAGE_STATE_CHANGE, state, -1).SendToTarget();
        }
        ...
        public void Connected(BluetoothSocket socket, BluetoothDevice device)
        {
            ...
            var msg = _handler.ObtainMessage(EqualizerController.MESSAGE_DEVICE_NAME);
            Bundle bundle = new Bundle();
            bundle.PutString(EqualizerController.DEVICE_NAME, device.Name);
            msg.Data = bundle;
        ...
        private void ConnectionFailed()
        {
            ...
            var msg = _handler.ObtainMessage(EqualizerController.MESSAGE_TOAST);
            Bundle bundle = new Bundle();
            bundle.PutString(EqualizerController.TOAST, "Unable to connect device");
            msg.Data = bundle;
            _handler.SendMessage(msg);
        }
        ...
        public void ConnectionLost()
        {
            ...
            var msg = _handler.ObtainMessage(EqualizerController.MESSAGE_TOAST);
            Bundle bundle = new Bundle();
            bundle.PutString(EqualizerController.TOAST, "Device connection was lost");
            msg.Data = bundle;
            _handler.SendMessage(msg);
        }
        ...
        private class AcceptThread : Thread
        {
            ...
            private BluetoothServices _service;

            public AcceptThread(BluetoothServices service)
            {
                _service = service;
            ...
            public override void Run()
            {
                ...
                while (_service._state != BluetoothServices.STATE_CONNECTED)
                {
                    try
                    {
        ...
        protected class ConnectThread : Thread
        {
            ...
            public ConnectThread(BluetoothDevice device, BluetoothServices service)
            {
                mmDevice = device;
                _service = service;
        ...
        private class ConnectedThread : Thread
        {
            ...
            public ConnectedThread(BluetoothSocket socket, BluetoothServices service)
            {
            ...
            public override void Run()
            {
                ...
                while (true)
                {
                    try
                    {
                        ...
                        _service._handler.ObtainMessage(EqualizerController.MESSAGE_READ, bytes, -1, buffer)
                            .SendToTarget();
                    }
                    catch (Java.IO.IOException e)
                    {
            ...
            public void Write(byte[] buffer)
            {
                try
                {
                    ...
                    _service._handler.ObtainMessage(EqualizerController.MESSAGE_WRITE, -1, -1, buffer)
                        .SendToTarget();
                }
                catch (Java.IO.IOException e)
                {
